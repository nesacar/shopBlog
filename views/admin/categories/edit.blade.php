...
@section('bredcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('admin/categories') }}">Kategorije prodavnice</a></li>
            ...
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! \App\Category::getSortCategoryRadio(false, $catids) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="brand_id" class="col-sm-2 control-label">Brend</label>
                        <div class="col-sm-10">
                            {!! Form::select('brand_id', $brands, $category->brand_id, array('class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::checkbox('publish', 1, $category->publish, ['class' => 'switch-state', 'data-on-color' => 'success', 'data-off-color' => 'danger', 'data-on-text' => 'DA', 'data-off-text' => 'NE', 'id' => 'active']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        @if($category->image != null && $category->image != '')
                            <div class="place">
                                <img src="{{ url($category->image) }}" alt="{{ $category->title }}" style="width: 100%; height: auto; margin-bottom: 10px">
                                <a class="btn btn-danger remove" href="{{ url('admin/categories/'.$category->id.'/deleteimg') }}">Obriši sliku</a>
                            </div>
                        @else
