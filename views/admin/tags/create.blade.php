        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    {!! Form::open(['action' => ['TagsController@store', $tag->id], 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                        {!! Form::hidden('locale', 'sr') !!}
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <input type="submit" class="btn btn-success pull-right" value="Sačuvaj">
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
